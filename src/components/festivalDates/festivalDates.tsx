                                            ...
                                            <CarouselContent>
                                                <CarouselItem>
                                                    <section className="flex flex-col">
                                                        <h3 className={`${poppins500.className} text-center`}>MAÑANA</h3>
                                                        {!morningDatesResult ? (
                                                                ...
                                                                if(new Date(morningEvent.date).getUTCDate().toString() === date.day){
                                                                    return (
                                                                        <article className="p-2 h-full flex flex-col gap-4" key={morningEvent.date}>
                                                                            <Image src={morningEvent.picture} alt={morningEvent.pictureAlt} width={800} height={800} className="w-100"/>
                                                                            <div>
                                                                ...
                                                                eveningDatesResult.map(eveningEvent =>{
                                                                    if(new Date(eveningEvent.date).getUTCDate().toLocaleString() === date.day){
                                                                        return (
                                                                            ...
                                                                            <Image src={eveningEvent.picture} alt={eveningEvent.pictureAlt} width={800} height={800} className="w-100 object-cover"/>
                                                                            <div>
                                                                    ...
                                                                    nightDatesResult.map(nightEvent => {
                                                                        if(new Date(nightEvent.date).getUTCDate().toLocaleString() === date.day){
                                                                            return (
                                                                                ...
                                                                                <Image src={nightEvent.picture} alt={nightEvent.pictureAlt} width={800} height={800} className="w-100 object-cover"/>
                                                                                <div>
